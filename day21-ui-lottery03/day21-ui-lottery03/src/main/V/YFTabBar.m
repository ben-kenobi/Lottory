...
-(void)initUI{
    ...
    for(int i=0;i<COUNT;i++){
        ...
        [btn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@"TabBar%d",i+1]] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@"TabBar%dSel",i+1]] forState:UIControlStateSelected];
        [self addSubview:btn];
        btn.tag=i;
